...
public:
    ...
    // XLA initialize may schedule compilation, but it must not retain call-frame data.
    virtual void initialize(int32_t device_ordinal) = 0;
};

// XLA owns this state. Interned kernel data remains shared across executables.
